...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			// 画出四个角
			paint.setColor(getResources().getColor(R.color.default_custom_actionbar_divider));
			// 左上角
			...
			canvas.drawRect(frame.left, frame.top, frame.left + 15,
					frame.top + 25, paint);
			// 右上角
			canvas.drawRect(frame.right - 25, frame.top, frame.right,
					frame.top + 15, paint);
			canvas.drawRect(frame.right - 15, frame.top, frame.right,
					frame.top + 25, paint);
			// 左下角
			canvas.drawRect(frame.left, frame.bottom - 15, frame.left + 25,
					frame.bottom, paint);
			canvas.drawRect(frame.left, frame.bottom - 25, frame.left + 15,
					frame.bottom, paint);
			// 右下角
			canvas.drawRect(frame.right - 25, frame.bottom - 15, frame.right,
					frame.bottom, paint);
			canvas.drawRect(frame.right - 15, frame.bottom - 25, frame.right,
					frame.bottom, paint);
